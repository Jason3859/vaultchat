...
import dev.jason.project.spring.vc_server.core.exception.VcException.SocialException.UserAlreadyBlockedException;
...
public class SocialService {
    ...
    public void block(String uid1, String uid2) {
        ...
        if (entity1.getBlocklist().contains(entity2.getUserId())) {
