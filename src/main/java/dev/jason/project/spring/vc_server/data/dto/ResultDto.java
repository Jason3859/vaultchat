...
public record ResultDto(Result result, Object data) {
    ...
    public static ResultDto fromVcException(VcException exception) {
        return switch (exception) {
            ...
            case BlockedByUserException ignored -> new ResultDto(Result.BlockedByUser);
            ...
            case UsersAlreadyConnectedException ignored -> new ResultDto(Result.UsersAlreadyConnected);
