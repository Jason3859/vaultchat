...
@Database(entities = [ConnectionsEntity::class], version = 2, exportSchema = false)
abstract class ConnectionsDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        fun getDatabase(context: Context): ConnectionsDatabase {
            return INSTANCE ?: Room.databaseBuilder(context, ConnectionsDatabase::class.java, "connections.db")
