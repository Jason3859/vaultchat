...
import dev.jason.app.compose.messenger.auth.ui.screen.login.AuthButton
...
@Composable
internal fun CompactEmailSigninScreen(
...
internal fun SigninEmailForm(
    ...
    Column(
        ...
        AuthButton(
            ...
            outlined = true,
            text = stringResource(R.string.login_using_email)
        )
    }
}
...
@Preview
@Composable
private fun CompactEmailSigninScreenLightModePreview() {
    MessengerTheme {
