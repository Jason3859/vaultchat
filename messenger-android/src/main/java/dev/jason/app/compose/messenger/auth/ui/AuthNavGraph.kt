package dev.jason.app.compose.messenger.auth.ui
...
import dev.jason.app.compose.messenger.MessengerActivity
import dev.jason.app.compose.messenger.auth.data.google.FirebaseGoogleAuthentication
import dev.jason.app.compose.messenger.auth.ui.route.AuthRoute
import dev.jason.app.compose.messenger.auth.ui.screen.email_auth.login.CompactEmailLoginScreen
import dev.jason.app.compose.messenger.auth.ui.screen.email_auth.login.ExtraLargeEmailLoginScreen
import dev.jason.app.compose.messenger.auth.ui.screen.email_auth.login.LandscapePhoneEmailLoginScreen
import dev.jason.app.compose.messenger.auth.ui.screen.email_auth.login.LargeEmailLoginScreen
import dev.jason.app.compose.messenger.auth.ui.screen.email_auth.signin.CompactEmailSigninScreen
import dev.jason.app.compose.messenger.auth.ui.screen.email_auth.signin.ExtraLargeEmailSigninScreen
import dev.jason.app.compose.messenger.auth.ui.screen.email_auth.signin.LandscapePhoneEmailSigninScreen
import dev.jason.app.compose.messenger.auth.ui.screen.email_auth.signin.LargeEmailSigninScreen
import dev.jason.app.compose.messenger.auth.ui.screen.login.CompactLoginScreen
import dev.jason.app.compose.messenger.auth.ui.screen.login.ExtraLargeLoginScreen
import dev.jason.app.compose.messenger.auth.ui.screen.login.LandscapePhoneLoginScreen
import dev.jason.app.compose.messenger.auth.ui.screen.login.LargeLoginScreen
import dev.jason.app.compose.messenger.auth.ui.util.DeviceType
import dev.jason.app.compose.messenger.auth.ui.util.SnackbarController
import dev.jason.app.compose.messenger.auth.ui.util.getDeviceType
import dev.jason.app.compose.messenger.auth.ui.util.isLandscapePhone
